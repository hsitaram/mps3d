...
! config
!
  integer, parameter :: species_max = 10, species_electrons = 1, species_length = 5, reactions_max = 20, reactions_length = 21
...
!
  ...
  integer, parameter, private               :: bolsig_species_max = 2, bolsig_species_length = 2 
...
!
  ...
  /"E    ","HE^+ ","HE2^+","N^+  ","N2^+ ","HE*  ","HE2* ","N    ","HE   ","N2   "/
  data reaction_sign(1:reactions_max) &
  /"E+HE=>HE*+E          ","E+HE*=>HE+E          ","E+HE=>HE^++E+E       ","E+HE*=>HE^++E+E      ","E+HE2*=>HE2^++E+E    ",&
   "E+HE2^+=>HE*+HE      ","HE*+HE*=>HE^++HE+E   ","HE*+HE+HE=>HE2*+HE   ","HE^++HE+HE=>HE2^++HE ","HE*+N2=>N2^++HE+E    ",&
   "HE2*+N2=>N2^++HE+HE+E","HE^++N2=>N2^++HE     ","HE^++N2=>N^++N+HE    ","HE2^++N2=>N2^++HE+HE ","HE2^++N2=>N^++N+HE+HE",&
   "E+E+N2^+=>N2+E       ","E+N2^+=>N+N          ","E+N2=>N+N+E          ","E+N=>N^++E+E         ","E+N2=>N2^++E+E       "/
...
300 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file <" &
    ...
    close(ifile_unit)
311 format(251x,10(1x,i9))
312 format(A2,1x,A21,1x,10(1x,A9))
313 format(i2,1x,A21,1x,10(1x,1pd9.2))
  endif
  return
...
100 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file " // &
    ...
    do i = 1, species_max
      write(ifile_unit,"(20(i3))",err=200) int(mrtm(i,:))
    enddo
    lerror = .false.
200 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file " // &
...
400 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file " // &
    ...
    write(ifile_unit,"(1x,A12,20(111x,i2.2))",err=500) "Time_s", ( i, i = 1, reactions_max )
    lerror = .false.
500 if( lerror ) call ZDPlasKin_stop("ZDPlasKin ERROR: cannot write to file " // &
  ...
  if( ( time - densav(0,1) ) >= rtol .or. lfirst ) then
    ...
    if( rtol > qtplaskin_rtol .or. lfirst ) then
      ...
      write(ifile_unit,"(21(1pe13.4))") densav(0,2), rrt_loc(:)
      close(ifile_unit)
      densav(:,1) = densav(:,2)
    endif
  endif
...
subroutine ZDPlasKin_reac_source_matrix(reac_rate_local,reac_source_local)
  ...
  reac_source_local(09,01) = - reac_rate_local(01) 
  ...
  reac_source_local(09,06) = + reac_rate_local(06) 
  reac_source_local(01,07) = + reac_rate_local(07) 
  reac_source_local(02,07) = + reac_rate_local(07) 
  reac_source_local(06,07) = - reac_rate_local(07) * 2.d0
  ...
  reac_source_local(09,10) = + reac_rate_local(10) 
  ...
  reac_source_local(09,11) = + reac_rate_local(11) * 2.d0
  ...
  reac_source_local(08,13) = + reac_rate_local(13) 
  ...
  reac_source_local(09,15) = + reac_rate_local(15) * 2.d0
  ...
  reac_source_local(08,17) = + reac_rate_local(17) * 2.d0
  reac_source_local(08,18) = + reac_rate_local(18) * 2.d0
  ...
  reac_source_local(08,19) = - reac_rate_local(19) 
...
subroutine ZDPlasKin_fex(neq,t,y,ydot)
  ...
  ydot(09) = -rrt(01)+rrt(02)-rrt(03)+rrt(06)+rrt(07)-rrt(08)-rrt(09)+rrt(10)+ 2.d0 * rrt(11)+rrt(12)+rrt(13)+ 2.d0 * rrt(14)&
             + 2.d0 * rrt(15) 
...
subroutine ZDPlasKin_jex(neq,t,y,ml,mu,pd,nrpd)
  ...
  density(:) = y(1:species_max)
  call ZDPlasKin_reac_rates(t)
  pd(06,01) = pd(06,01) + rrt(01) * density(09) 
  pd(06,09) = pd(06,09) + rrt(01) * density(01) 
  pd(09,01) = pd(09,01) - rrt(01) * density(09) 
  pd(09,09) = pd(09,09) - rrt(01) * density(01) 
  pd(06,01) = pd(06,01) - rrt(02) * density(06) 
  pd(06,06) = pd(06,06) - rrt(02) * density(01) 
  pd(09,01) = pd(09,01) + rrt(02) * density(06) 
  pd(09,06) = pd(09,06) + rrt(02) * density(01) 
  pd(01,01) = pd(01,01) + rrt(03) * density(09) 
  pd(01,09) = pd(01,09) + rrt(03) * density(01) 
  pd(02,01) = pd(02,01) + rrt(03) * density(09) 
  pd(02,09) = pd(02,09) + rrt(03) * density(01) 
  pd(09,01) = pd(09,01) - rrt(03) * density(09) 
  pd(09,09) = pd(09,09) - rrt(03) * density(01) 
  pd(01,01) = pd(01,01) + rrt(04) * density(06) 
  pd(01,06) = pd(01,06) + rrt(04) * density(01) 
  pd(02,01) = pd(02,01) + rrt(04) * density(06) 
  pd(02,06) = pd(02,06) + rrt(04) * density(01) 
  pd(06,01) = pd(06,01) - rrt(04) * density(06) 
  pd(06,06) = pd(06,06) - rrt(04) * density(01) 
  pd(01,01) = pd(01,01) + rrt(05) * density(07) 
  pd(01,07) = pd(01,07) + rrt(05) * density(01) 
  pd(03,01) = pd(03,01) + rrt(05) * density(07) 
  pd(03,07) = pd(03,07) + rrt(05) * density(01) 
  pd(07,01) = pd(07,01) - rrt(05) * density(07) 
  pd(07,07) = pd(07,07) - rrt(05) * density(01) 
  pd(01,01) = pd(01,01) - rrt(06) * density(03) 
  pd(01,03) = pd(01,03) - rrt(06) * density(01) 
  pd(03,01) = pd(03,01) - rrt(06) * density(03) 
  pd(03,03) = pd(03,03) - rrt(06) * density(01) 
  pd(06,01) = pd(06,01) + rrt(06) * density(03) 
  pd(06,03) = pd(06,03) + rrt(06) * density(01) 
  pd(09,01) = pd(09,01) + rrt(06) * density(03) 
  pd(09,03) = pd(09,03) + rrt(06) * density(01) 
  pd(01,06) = pd(01,06) + rrt(07) * density(06) * 2.0d0
  pd(02,06) = pd(02,06) + rrt(07) * density(06) * 2.0d0
  pd(06,06) = pd(06,06) - rrt(07) * density(06) * 4.0d0
  pd(09,06) = pd(09,06) + rrt(07) * density(06) * 2.0d0
  pd(06,06) = pd(06,06) - rrt(08) * density(09)**2 
  pd(06,09) = pd(06,09) - rrt(08) * density(06) * density(09) * 2.0d0
  pd(07,06) = pd(07,06) + rrt(08) * density(09)**2 
  pd(07,09) = pd(07,09) + rrt(08) * density(06) * density(09) * 2.0d0
  pd(09,06) = pd(09,06) - rrt(08) * density(09)**2 
  pd(09,09) = pd(09,09) - rrt(08) * density(06) * density(09) * 2.0d0
  pd(02,02) = pd(02,02) - rrt(09) * density(09)**2 
  pd(02,09) = pd(02,09) - rrt(09) * density(02) * density(09) * 2.0d0
  pd(03,02) = pd(03,02) + rrt(09) * density(09)**2 
  pd(03,09) = pd(03,09) + rrt(09) * density(02) * density(09) * 2.0d0
  pd(09,02) = pd(09,02) - rrt(09) * density(09)**2 
  pd(09,09) = pd(09,09) - rrt(09) * density(02) * density(09) * 2.0d0
  pd(01,06) = pd(01,06) + rrt(10) * density(10) 
  pd(01,10) = pd(01,10) + rrt(10) * density(06) 
  pd(05,06) = pd(05,06) + rrt(10) * density(10) 
  pd(05,10) = pd(05,10) + rrt(10) * density(06) 
  pd(06,06) = pd(06,06) - rrt(10) * density(10) 
  pd(06,10) = pd(06,10) - rrt(10) * density(06) 
  pd(09,06) = pd(09,06) + rrt(10) * density(10) 
  pd(09,10) = pd(09,10) + rrt(10) * density(06) 
  pd(10,06) = pd(10,06) - rrt(10) * density(10) 
  pd(10,10) = pd(10,10) - rrt(10) * density(06) 
  pd(01,07) = pd(01,07) + rrt(11) * density(10) 
  pd(01,10) = pd(01,10) + rrt(11) * density(07) 
  pd(05,07) = pd(05,07) + rrt(11) * density(10) 
  pd(05,10) = pd(05,10) + rrt(11) * density(07) 
  pd(07,07) = pd(07,07) - rrt(11) * density(10) 
  pd(07,10) = pd(07,10) - rrt(11) * density(07) 
  pd(09,07) = pd(09,07) + rrt(11) * density(10) * 2.0d0
  pd(09,10) = pd(09,10) + rrt(11) * density(07) * 2.0d0
  pd(10,07) = pd(10,07) - rrt(11) * density(10) 
  pd(10,10) = pd(10,10) - rrt(11) * density(07) 
  pd(02,02) = pd(02,02) - rrt(12) * density(10) 
  pd(02,10) = pd(02,10) - rrt(12) * density(02) 
  pd(05,02) = pd(05,02) + rrt(12) * density(10) 
  pd(05,10) = pd(05,10) + rrt(12) * density(02) 
  pd(09,02) = pd(09,02) + rrt(12) * density(10) 
  pd(09,10) = pd(09,10) + rrt(12) * density(02) 
  pd(10,02) = pd(10,02) - rrt(12) * density(10) 
  pd(10,10) = pd(10,10) - rrt(12) * density(02) 
  pd(02,02) = pd(02,02) - rrt(13) * density(10) 
  pd(02,10) = pd(02,10) - rrt(13) * density(02) 
  pd(04,02) = pd(04,02) + rrt(13) * density(10) 
  pd(04,10) = pd(04,10) + rrt(13) * density(02) 
  pd(08,02) = pd(08,02) + rrt(13) * density(10) 
  pd(08,10) = pd(08,10) + rrt(13) * density(02) 
  pd(09,02) = pd(09,02) + rrt(13) * density(10) 
  pd(09,10) = pd(09,10) + rrt(13) * density(02) 
  pd(10,02) = pd(10,02) - rrt(13) * density(10) 
  pd(10,10) = pd(10,10) - rrt(13) * density(02) 
  pd(03,03) = pd(03,03) - rrt(14) * density(10) 
  pd(03,10) = pd(03,10) - rrt(14) * density(03) 
  pd(05,03) = pd(05,03) + rrt(14) * density(10) 
  pd(05,10) = pd(05,10) + rrt(14) * density(03) 
  pd(09,03) = pd(09,03) + rrt(14) * density(10) * 2.0d0
  pd(09,10) = pd(09,10) + rrt(14) * density(03) * 2.0d0
  pd(10,03) = pd(10,03) - rrt(14) * density(10) 
  pd(10,10) = pd(10,10) - rrt(14) * density(03) 
  pd(03,03) = pd(03,03) - rrt(15) * density(10) 
  pd(03,10) = pd(03,10) - rrt(15) * density(03) 
  pd(04,03) = pd(04,03) + rrt(15) * density(10) 
  pd(04,10) = pd(04,10) + rrt(15) * density(03) 
  pd(08,03) = pd(08,03) + rrt(15) * density(10) 
  pd(08,10) = pd(08,10) + rrt(15) * density(03) 
  pd(09,03) = pd(09,03) + rrt(15) * density(10) * 2.0d0
  pd(09,10) = pd(09,10) + rrt(15) * density(03) * 2.0d0
  pd(10,03) = pd(10,03) - rrt(15) * density(10) 
  pd(10,10) = pd(10,10) - rrt(15) * density(03) 
  pd(01,01) = pd(01,01) - rrt(16) * density(01) * density(05) * 2.0d0
  pd(01,05) = pd(01,05) - rrt(16) * density(01)**2 
  pd(05,01) = pd(05,01) - rrt(16) * density(01) * density(05) * 2.0d0
  pd(05,05) = pd(05,05) - rrt(16) * density(01)**2 
  pd(10,01) = pd(10,01) + rrt(16) * density(01) * density(05) * 2.0d0
  pd(10,05) = pd(10,05) + rrt(16) * density(01)**2 
  pd(01,01) = pd(01,01) - rrt(17) * density(05) 
  pd(01,05) = pd(01,05) - rrt(17) * density(01) 
  pd(05,01) = pd(05,01) - rrt(17) * density(05) 
  pd(05,05) = pd(05,05) - rrt(17) * density(01) 
  pd(08,01) = pd(08,01) + rrt(17) * density(05) * 2.0d0
  pd(08,05) = pd(08,05) + rrt(17) * density(01) * 2.0d0
  pd(08,01) = pd(08,01) + rrt(18) * density(10) * 2.0d0
  pd(08,10) = pd(08,10) + rrt(18) * density(01) * 2.0d0
  pd(10,01) = pd(10,01) - rrt(18) * density(10) 
  pd(10,10) = pd(10,10) - rrt(18) * density(01) 
  pd(01,01) = pd(01,01) + rrt(19) * density(08) 
  pd(01,08) = pd(01,08) + rrt(19) * density(01) 
  pd(04,01) = pd(04,01) + rrt(19) * density(08) 
  pd(04,08) = pd(04,08) + rrt(19) * density(01) 
  pd(08,01) = pd(08,01) - rrt(19) * density(08) 
  pd(08,08) = pd(08,08) - rrt(19) * density(01) 
  pd(01,01) = pd(01,01) + rrt(20) * density(10) 
  pd(01,10) = pd(01,10) + rrt(20) * density(01) 
  pd(05,01) = pd(05,01) + rrt(20) * density(10) 
  pd(05,10) = pd(05,10) + rrt(20) * density(01) 
  pd(10,01) = pd(10,01) - rrt(20) * density(10) 
  pd(10,10) = pd(10,10) - rrt(20) * density(01) 
