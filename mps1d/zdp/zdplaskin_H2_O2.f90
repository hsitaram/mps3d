...
! config
!
  integer, parameter :: species_max = 10, species_electrons = 3, species_length = 4, reactions_max = 15, reactions_length = 19
...
!
  ...
  /"H2  ","O2  ","E   ","H^+ ","H2^+","O^+ ","O2^+","O^- ","H   ","O   "/
  data reaction_sign(1:reactions_max) &
  /"H+E=>H^++E+E       ","H2+E=>H^++H+E+E    ","H2^++E=>H^++H+E    ","H2^++E=>H^++H^++E+E","H2^++H=>H2+H^+     ",&
   "H2+H^+=>H2^++H     ","H2+E=>H2^++E+E     ","H2+E=>H+H+E        ","O2+E=>O2^++E+E     ","O2+E=>O+O+E        ",&
   "O2+E=>O+O^-        ","O+E=>O^++E+E       ","O^-+O2^+=>O+O2     ","O^-+O^+=>O+O       ","O^-+E=>O+E+E       "/
...
subroutine ZDPlasKin_reac_source_matrix(reac_rate_local,reac_source_local)
  ...
  reac_source_local(04,04) = + reac_rate_local(04) * 2.d0
  ...
  reac_source_local(09,08) = + reac_rate_local(08) * 2.d0
  ...
  reac_source_local(10,10) = + reac_rate_local(10) * 2.d0
  reac_source_local(02,11) = - reac_rate_local(11) 
  reac_source_local(03,11) = - reac_rate_local(11) 
  reac_source_local(08,11) = + reac_rate_local(11) 
  ...
  reac_source_local(06,14) = - reac_rate_local(14) 
  reac_source_local(08,14) = - reac_rate_local(14) 
  reac_source_local(10,14) = + reac_rate_local(14) * 2.d0
...
subroutine ZDPlasKin_fex(neq,t,y,ydot)
  ...
  rrt(01) = rrt(01) * density(03) * density(09) 
  rrt(02) = rrt(02) * density(01) * density(03) 
  rrt(03) = rrt(03) * density(03) * density(05) 
  rrt(04) = rrt(04) * density(03) * density(05) 
  rrt(05) = rrt(05) * density(05) * density(09) 
  rrt(06) = rrt(06) * density(01) * density(04) 
  rrt(07) = rrt(07) * density(01) * density(03) 
  rrt(08) = rrt(08) * density(01) * density(03) 
  rrt(09) = rrt(09) * density(02) * density(03) 
  rrt(10) = rrt(10) * density(02) * density(03) 
  rrt(11) = rrt(11) * density(02) * density(03) 
  rrt(12) = rrt(12) * density(03) * density(10) 
  rrt(13) = rrt(13) * density(07) * density(08) 
  rrt(14) = rrt(14) * density(06) * density(08) 
  rrt(15) = rrt(15) * density(03) * density(08) 
  ydot(01) = -rrt(02)+rrt(05)-rrt(06)-rrt(07)-rrt(08) 
  ydot(02) = -rrt(09)-rrt(10)-rrt(11)+rrt(13) 
  ydot(03) = +rrt(01)+rrt(02)+rrt(04)+rrt(07)+rrt(09)-rrt(11)+rrt(12)+rrt(15) 
  ydot(04) = +rrt(01)+rrt(02)+rrt(03)+ 2.d0 * rrt(04)+rrt(05)-rrt(06) 
  ydot(05) = -rrt(03)-rrt(04)-rrt(05)+rrt(06)+rrt(07) 
  ydot(06) = +rrt(12)-rrt(14) 
  ydot(07) = +rrt(09)-rrt(13) 
  ydot(08) = +rrt(11)-rrt(13)-rrt(14)-rrt(15) 
  ydot(09) = -rrt(01)+rrt(02)+rrt(03)-rrt(05)+rrt(06)+ 2.d0 * rrt(08) 
  ydot(10) = + 2.d0 * rrt(10)+rrt(11)-rrt(12)+rrt(13)+ 2.d0 * rrt(14)+rrt(15) 
...
subroutine ZDPlasKin_jex(neq,t,y,ml,mu,pd,nrpd)
  ...
  density(:) = y(1:species_max)
  call ZDPlasKin_reac_rates(t)
  pd(03,03) = pd(03,03) + rrt(01) * density(09) 
  pd(03,09) = pd(03,09) + rrt(01) * density(03) 
  pd(04,03) = pd(04,03) + rrt(01) * density(09) 
  pd(04,09) = pd(04,09) + rrt(01) * density(03) 
  pd(09,03) = pd(09,03) - rrt(01) * density(09) 
  pd(09,09) = pd(09,09) - rrt(01) * density(03) 
  ...
  pd(04,03) = pd(04,03) + rrt(03) * density(05) 
  pd(04,05) = pd(04,05) + rrt(03) * density(03) 
  pd(05,03) = pd(05,03) - rrt(03) * density(05) 
  pd(05,05) = pd(05,05) - rrt(03) * density(03) 
  pd(09,03) = pd(09,03) + rrt(03) * density(05) 
  pd(09,05) = pd(09,05) + rrt(03) * density(03) 
  pd(03,03) = pd(03,03) + rrt(04) * density(05) 
  pd(03,05) = pd(03,05) + rrt(04) * density(03) 
  pd(04,03) = pd(04,03) + rrt(04) * density(05) * 2.0d0
  pd(04,05) = pd(04,05) + rrt(04) * density(03) * 2.0d0
  pd(05,03) = pd(05,03) - rrt(04) * density(05) 
  pd(05,05) = pd(05,05) - rrt(04) * density(03) 
  pd(01,05) = pd(01,05) + rrt(05) * density(09) 
  pd(01,09) = pd(01,09) + rrt(05) * density(05) 
  pd(04,05) = pd(04,05) + rrt(05) * density(09) 
  pd(04,09) = pd(04,09) + rrt(05) * density(05) 
  pd(05,05) = pd(05,05) - rrt(05) * density(09) 
  pd(05,09) = pd(05,09) - rrt(05) * density(05) 
  pd(09,05) = pd(09,05) - rrt(05) * density(09) 
  pd(09,09) = pd(09,09) - rrt(05) * density(05) 
  pd(01,01) = pd(01,01) - rrt(06) * density(04) 
  pd(01,04) = pd(01,04) - rrt(06) * density(01) 
  pd(04,01) = pd(04,01) - rrt(06) * density(04) 
  pd(04,04) = pd(04,04) - rrt(06) * density(01) 
  pd(05,01) = pd(05,01) + rrt(06) * density(04) 
  pd(05,04) = pd(05,04) + rrt(06) * density(01) 
  pd(09,01) = pd(09,01) + rrt(06) * density(04) 
  pd(09,04) = pd(09,04) + rrt(06) * density(01) 
  ...
  pd(05,01) = pd(05,01) + rrt(07) * density(03) 
  pd(05,03) = pd(05,03) + rrt(07) * density(01) 
  pd(01,01) = pd(01,01) - rrt(08) * density(03) 
  pd(01,03) = pd(01,03) - rrt(08) * density(01) 
  pd(09,01) = pd(09,01) + rrt(08) * density(03) * 2.0d0
  pd(09,03) = pd(09,03) + rrt(08) * density(01) * 2.0d0
  pd(02,02) = pd(02,02) - rrt(09) * density(03) 
  pd(02,03) = pd(02,03) - rrt(09) * density(02) 
  pd(03,02) = pd(03,02) + rrt(09) * density(03) 
  pd(03,03) = pd(03,03) + rrt(09) * density(02) 
  pd(07,02) = pd(07,02) + rrt(09) * density(03) 
  pd(07,03) = pd(07,03) + rrt(09) * density(02) 
  pd(02,02) = pd(02,02) - rrt(10) * density(03) 
  pd(02,03) = pd(02,03) - rrt(10) * density(02) 
  pd(10,02) = pd(10,02) + rrt(10) * density(03) * 2.0d0
  pd(10,03) = pd(10,03) + rrt(10) * density(02) * 2.0d0
  pd(02,02) = pd(02,02) - rrt(11) * density(03) 
  pd(02,03) = pd(02,03) - rrt(11) * density(02) 
  pd(03,02) = pd(03,02) - rrt(11) * density(03) 
  pd(03,03) = pd(03,03) - rrt(11) * density(02) 
  pd(08,02) = pd(08,02) + rrt(11) * density(03) 
  pd(08,03) = pd(08,03) + rrt(11) * density(02) 
  pd(10,02) = pd(10,02) + rrt(11) * density(03) 
  pd(10,03) = pd(10,03) + rrt(11) * density(02) 
  pd(03,03) = pd(03,03) + rrt(12) * density(10) 
  pd(03,10) = pd(03,10) + rrt(12) * density(03) 
  pd(06,03) = pd(06,03) + rrt(12) * density(10) 
  pd(06,10) = pd(06,10) + rrt(12) * density(03) 
  pd(10,03) = pd(10,03) - rrt(12) * density(10) 
  pd(10,10) = pd(10,10) - rrt(12) * density(03) 
  pd(02,07) = pd(02,07) + rrt(13) * density(08) 
  pd(02,08) = pd(02,08) + rrt(13) * density(07) 
  pd(07,07) = pd(07,07) - rrt(13) * density(08) 
  pd(07,08) = pd(07,08) - rrt(13) * density(07) 
  pd(08,07) = pd(08,07) - rrt(13) * density(08) 
  pd(08,08) = pd(08,08) - rrt(13) * density(07) 
  pd(10,07) = pd(10,07) + rrt(13) * density(08) 
  pd(10,08) = pd(10,08) + rrt(13) * density(07) 
  pd(06,06) = pd(06,06) - rrt(14) * density(08) 
  pd(06,08) = pd(06,08) - rrt(14) * density(06) 
  pd(08,06) = pd(08,06) - rrt(14) * density(08) 
  pd(08,08) = pd(08,08) - rrt(14) * density(06) 
  pd(10,06) = pd(10,06) + rrt(14) * density(08) * 2.0d0
  pd(10,08) = pd(10,08) + rrt(14) * density(06) * 2.0d0
  pd(03,03) = pd(03,03) + rrt(15) * density(08) 
  pd(03,08) = pd(03,08) + rrt(15) * density(03) 
  pd(08,03) = pd(08,03) - rrt(15) * density(08) 
  pd(08,08) = pd(08,08) - rrt(15) * density(03) 
  pd(10,03) = pd(10,03) + rrt(15) * density(08) 
  pd(10,08) = pd(10,08) + rrt(15) * density(03) 
...
subroutine ZDPlasKin_reac_rates(Time)
  ...
  call ZDPlasKin_bolsig_rates()
  Te  = ZDPlasKin_cfg(4)
  rrt(01) = (6.5023D-09)*(TE**0.48931)*EXP(-149624.36/TE)
  rrt(02) = (2.9962D-08)*(TE**0.44456)*EXP(-437818.75/TE)
  rrt(03) = (1.0702D-07)*(TE**0.04876)*EXP(-112450.85/TE)
  rrt(04) = (2.1202D-09)*(TE**0.31394)*EXP(-270371.5/TE)
  rrt(05) = 9.0D-10
  rrt(06) = 1.19D-22
  rrt(07) = (3.1228D-08)*(TE**0.17156)*EXP(-232987.49/TE)
  rrt(08) = (1.7527D-7)*(TE**-1.23668)*EXP(-146128.85/TE)
  rrt(09) = (9.0D-10)*(TE**0.5)*EXP(-146216.7/TE)
  rrt(10) = (4.23D-9)*EXP(-64521.02/TE)
  rrt(11) = (8.8D-11)*EXP(-51059.8/TE)
  rrt(12) = (9.D-09)*(TE**0.7)*EXP(-157821.2/TE)
  rrt(13) = 1.99D-07
  rrt(14) = 2.66D-07
  rrt(15) = 2.0D-07*EXP(-63824.75/TE)
